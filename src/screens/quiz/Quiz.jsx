...
const QuizCard = () => {
    ...
    useEffect(() => {
        const getQuestion = databases.listDocuments(
            "6475bc41d08143bd0b2e",
            "6475bc4f578738f63e3c"
        );
        getQuestion.then(
            function (response) {

...
const PostFlat = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const minstayInt = parseInt(minstay);
        const phonenumInt = parseInt(phonenum);

        // if (isNaN(areaFloat)) {
        //     console.log("Invalid area input. Please enter a valid number.");
        //     return;
        // }

        // if (isNaN(rentFloat)) {
        //     console.log("Invalid rent input. Please enter a valid number.");
        //     return;
        // }
        ...
        const storing = storage.createFile(
            "6480d843935646ed03ca",
            ID.unique(),
            document.getElementById("flatPhoto").files[0]
        );
        promise.then(
            function (response) {
            ...
            <form className="postflat-form" onSubmit={handleSubmit}>
                <div className="flat-group">
                    ...
                    <fieldset>
                        ...
                        />
                        <label htmlFor="flat" className="label-pop">
                            Flat
                        </label>
                        ...
                        <input
                            ...
                            onChange={(e) => setPropType(e.target.value)}
                        />
                        <label htmlFor="house" className="label-pop">
                            House
                        </label>
                        ...
                        <input
                            ...
                            onChange={(e) => setPropType(e.target.value)}
                        />
                        <label htmlFor="dorm" className="label-pop">
                            Dorm
                        </label>
                    </fieldset>
                </div>
                ...
                <div className="flat-group">
                    ...
                    <fieldset>
                        ...
                        />
                        <label htmlFor="private_room" className="label-pop">
                            Private Room
                        </label>
                        ...
                        <input
                            ...
                            onChange={(e) => setRoomType(e.target.value)}
                        />
                        <label htmlFor="shared_room" className="label-pop">
                            Shared Room
                        </label>
                    </fieldset>
                </div>
                ...
                <div className="flat-group">
                    ...
                    <fieldset>
                        ...
                        />
                        <label htmlFor="male" className="label-pop">
                            Male
                        </label>
                        ...
                        <input
                            ...
                            onChange={(e) => setGender(e.target.value)}
                        />
                        <label htmlFor="female" className="label-pop">
                            Female
                        </label>
                        ...
                        <input
                            ...
                            onChange={(e) => setGender(e.target.value)}
                        />
                        <label htmlFor="anygender" className="label-pop">
                            Doesn't Matter
                        </label>
                    </fieldset>
                </div>
                ...
                <div className="flat-group">
                    ...
                    <fieldset>
                        ...
                        />
                        <label htmlFor="student" className="label-pop">
                            Student
                        </label>
                        ...
                        <input
                            ...
                            onChange={(e) => setOccupation(e.target.value)}
                        />
                        <label htmlFor="professional" className="label-pop">
                            Professional
                        </label>
                        ...
                        <input
                            ...
                            onChange={(e) => setOccupation(e.target.value)}
                        />
                        <label htmlFor="anyoccupation" className="label-pop">
                            Doesn't Matter
                        </label>
                    </fieldset>
                </div>
                ...
                <div className="flat-group">
                    ...
                    <fieldset>
                        ...
                        />
                        <label htmlFor="1availableBeds" className="label-pop">
                            1
                        </label>
                        ...
                        <input
                            ...
                            onChange={(e) => setBedsAvail(e.target.value)}
                        />
                        <label htmlFor="2availableBeds" className="label-pop">
                            2
                        </label>
                        ...
                        <input
                            ...
                            onChange={(e) => setBedsAvail(e.target.value)}
                        />
                        <label htmlFor="3availableBeds" className="label-pop">
                            3
                        </label>
                        ...
                        <input
                            ...
                            onChange={(e) => setBedsAvail(e.target.value)}
                        />
                        <label htmlFor="3+availableBeds" className="label-pop">
                            3+
                        </label>
                    </fieldset>
                </div>
                ...
                <div className="flat-group">
                    ...
                    <p className="age-p">
                        Age selected is {ageRange.min} - {ageRange.max}
                    </p>
                </div>
